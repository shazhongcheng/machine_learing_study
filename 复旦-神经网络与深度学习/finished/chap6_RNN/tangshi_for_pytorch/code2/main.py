...
def run_training():
    ...
    poems_vector, word_to_int, vocabularies = process_poems1('./code2/poems.txt')
    # 生成batch
    ...
    #     torch.load('./poem_generator_rnn'))  # if you have already trained your model you can load it by this line.
    ...
    for epoch in range(30):
        ...
        for batch in range(n_chunk):
            ...
            if batch % 20 ==0:
                torch.save(rnn_model.state_dict(), './code2/poem_generator_rnn')
...
def gen_poem(begin_word,model):
    ...
    poems_vector, word_int_map, vocabularies = process_poems1('./code2/poems.txt')
    ...
    rnn_model.load_state_dict(torch.load(model))
    ...
    while word != end_token:
        ...
        output,hn = rnn_model(input, is_test=True,hidden=hn)
